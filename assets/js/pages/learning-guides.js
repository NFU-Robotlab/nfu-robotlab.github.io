const docDatabase = {
            'stm32-f4': `
                ...
                <div class="p-4 bg-indigo-50 border-l-4 border-indigo-500 rounded-r-xl text-xs sm:text-sm text-slate-700 leading-relaxed mb-5">
                    <strong>💡 鐵人賽優秀技術導引：</strong><br>
                    本教學完整收錄並改編自實驗室 <strong>ziteh 學長</strong> 於第 14 屆 iT 邦幫忙鐵人賽發表的經典系列專題：<br><br>
                    <a href="https://ithelp.ithome.com.tw/users/20151756/ironman/5382" target="_blank" rel="noopener noreferrer" class="text-indigo-600 font-bold hover:underline inline-flex items-center gap-1">
            ...
            'yolo-learning': `
                ...
                <div class="p-4 bg-indigo-50 border-l-4 border-indigo-500 rounded-r-xl text-xs sm:text-sm text-slate-700 leading-relaxed mb-5">
                    ...
                    <a href="https://www.youtube.com/watch?v=SU_XvZKrClA&list=PLEP2u1-Xck9DZcjBKx4_HLt8-p9_GLkkG&index=27" target="_blank" rel="noopener noreferrer" class="text-indigo-600 font-bold hover:underline inline-flex items-center gap-1">
            ...
            'git-learning': `
                ...
                <div class="p-4 bg-indigo-50 border-l-4 border-indigo-500 rounded-r-xl text-xs sm:text-sm text-slate-700 leading-relaxed mb-5">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-2 mb-5 font-mono text-[10px] sm:text-xs">
                        <span class="bg-white/70 border border-indigo-100 rounded-lg px-3 py-2">git init</span>
                        <span class="bg-white/70 border border-indigo-100 rounded-lg px-3 py-2">git add</span>
                        <span class="bg-white/70 border border-indigo-100 rounded-lg px-3 py-2">git commit</span>
                        <span class="bg-white/70 border border-indigo-100 rounded-lg px-3 py-2">git branch</span>
                        <span class="bg-white/70 border border-indigo-100 rounded-lg px-3 py-2">git merge</span>
                        <span class="bg-white/70 border border-indigo-100 rounded-lg px-3 py-2">git push / pull</span>
                    </div>

                    <a href="https://www.youtube.com/watch?v=PNEM7CH3ZAg&list=PLYrA-SsMvTPOZeB6DHvB0ewl3miMf-2tj" target="_blank" rel="noopener noreferrer" class="text-indigo-600 font-bold hover:underline inline-flex items-center gap-1">
                        🔗 前往觀看 Git 學習影片播放清單 ➔
                    </a><br><br>
        ...
        function openDoc(topicId) {
            ...
            if (modal && body && docDatabase[topicId]) {
                body.innerHTML = docDatabase[topicId];
